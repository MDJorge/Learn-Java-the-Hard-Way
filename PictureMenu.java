...
public class PictureMenu
{
	public static void main( String[] args )
	{
		...
		{
			butterfly();
			//if you write this function twice, it gets printed twice
		}
		else if ( choice == 2 )
		{
			elephant();
		...
		{
			teddybear(); // * write code here to call the function named 'teddybear'
		}
		else if ( choice == 4 )
		{
			snake(); // * write code here to call the function named 'snake'
		}
		else 
		{
